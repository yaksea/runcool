...
export const level7: LevelDef = {
  ...
  gates: [
    { id: 'gate7a', x: 3000, y: 640, w: 26, h: 100 },
      ...
      levers: [
    { x: 3260, y: 760, targetId: 'gate7a', targetType: 'gate' },
    { x: 1080, y: 300, targetId: 'cv7a', targetType: 'conveyor' },
    { x: 1500, y: 380, targetId: 'fan7a', targetType: 'fan' },
    { x: 2487, y: 460, targetId: 'cv7b', targetType: 'conveyor' },
  ],
  breakables: [
