...
export const level7: LevelDef = {
  ...
  geysers: [
    { x: 1060, y: 560, intervalMs: 1300, force: 800 },
    { x: 2620, y: 580, intervalMs: 1500, force: 760 },
  ],
  timedPlatforms: [
    { x: 1300, y: 440, w: 100, h: 20, onMs: 1000, offMs: 700 },
    { x: 2500, y: 360, w: 100, h: 20, onMs: 1100, offMs: 750 },
    { x: 3080, y: 760, w: 100, h: 20, onMs: 1200, offMs: 700 },
  ],
  gates: [
    { id: 'gate7a', x: 3000, y: 640, w: 26, h: 100 },
  ],
  levers: [
    { x: 3120, y: 760, targetId: 'gate7a', targetType: 'gate' },
  ...
  spikes: [
    { x: 480, y: 400, count: 3 },
    { x: 940, y: 560, count: 4 },
    { x: 1460, y: 380, count: 4 },
    { x: 1840, y: 280, count: 3 },
    { x: 2280, y: 340, count: 3 },
    { x: 2800, y: 580, count: 3 },
  ],
  flameVents: [
    { x: 1240, y: 500, intervalMs: 700, height: 150 },
    { x: 1720, y: 280, intervalMs: 650, height: 140 },
    { x: 2160, y: 340, intervalMs: 700, height: 145 },
    { x: 2720, y: 580, intervalMs: 650, height: 140 },
    { x: 740, y: 480, intervalMs: 750, height: 130 },
  ],
  acidPools: [
    { x: 1040, y: 300, w: 84 },
    { x: 1960, y: 220, w: 90 },
